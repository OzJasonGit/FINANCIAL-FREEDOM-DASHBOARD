...
import {SiShadow, SiShopware} from 'react-icons/si';
...
const Sidebar = () => {
  ...
  return (
    <div className='bg-stone-200 ml-3 h-screen
        ...
        md:hover:overflow-auto pb-10'>
          ...
          item-center'>
            ...
            <Link to="/" 
              ...
              className='items-center gap-3 ml-3 pt-3
              first-letter:mt-4 flex text-xl font-extrabold 
              tracking-tight dark:text-white
              text-slate-900'>
              <SiShopware/> <span>PF_BD</span>  
            </Link>
